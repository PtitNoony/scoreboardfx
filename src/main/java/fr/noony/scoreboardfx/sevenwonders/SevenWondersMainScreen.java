...
public class SevenWondersMainScreen implements Screen {
    ...
    private SevenWondersMainScreenController controller;
    private Node screenNode;

    public SevenWondersMainScreen() {
        propertyChangeSupport = new PropertyChangeSupport(SevenWondersMainScreen.this);
        loadFXML();
    }
    ...
    private void loadFXML() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("SevenWondersMainScreen.fxml"));
